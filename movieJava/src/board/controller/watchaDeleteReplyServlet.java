...
/**
 * Servlet implementation class watchaDeleteReplyServlet
 */
@WebServlet("/watcha/deleteReply")
public class watchaDeleteReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public watchaDeleteReplyServlet() {
        super();
