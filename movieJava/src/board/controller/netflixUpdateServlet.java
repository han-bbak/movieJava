...
/**
 * Servlet implementation class netflixUpdateServlet
 */
@WebServlet("/netflix/update")
public class netflixUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public netflixUpdateServlet() {
        super();
