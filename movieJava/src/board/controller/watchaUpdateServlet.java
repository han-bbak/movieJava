...
/**
 * Servlet implementation class watchaUpdateServlet
 */
@WebServlet("/watcha/update")
public class watchaUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public watchaUpdateServlet() {
        super();
