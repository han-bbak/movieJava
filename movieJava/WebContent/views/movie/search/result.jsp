...
.font1 {
	font-size: 30px font-family: 'Noto Sans KR', sans-serif;
}
</style>
</head>
		...
		<div id="header">
			...
			<div class="header" id="header1">
				<a href="<%= request.getContextPath() %>/home.jsp"><img
					class="logo" src="/movieJava/images/logo.png"></a>
			</div>
			<div class="header" id="header2">

				<!----- 영화 검색 ----->
				<form id="search-form"
					action="<%=request.getContextPath()%>/movie/search" method="get">
...
<body>
  ...
  <%--   $(function() {         
	...
	<div class="content" id="content1">
		...
		<div class="toggles">
			<form id="filtering"
				action="<%=request.getContextPath()%>/movie/search">
				<input type="hidden" name="search"
					value="<%=request.getParameter("search")%>"> <select
					id="filter" name="genre">
				...
				</select> <select id="filter2" name="sort">
      ...
      $(function(){
		...
		<div class="posts">
            ...
            %>
				...
				<a
					href="detail?mCode=<%= Movie.getM_code() %>"></a>
					
				<div class="m_thumb">
					<img alt="" src="<%= Movie.getM_image()%>" width="150" height="200">
					
                  		<%  if(Movie.getStatus().equals("true")) { %>
						<div class="nIcon">
