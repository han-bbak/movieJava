...
<body>
	...
	<script src="WebContent/views/movie/js/slick/slick.js" type="text/javascript" charset="utf-8"></script>
   ...
   $(document).on('ready', function() {
    ...
    $.fn.slick = function() {
		...
		<div class="scheduled" id="content3">
			<p>#개봉예정</p>
			<%@ include file="/views/movie/main/scheduled.jsp"%>
		</div>
	</div>
